...
bool Assembler::isTwoOperand(Opcode opcode) {
    if(opcode == CMP || opcode == NOT || opcode == MOV || opcode==MOVZ) // add
        return true;
    return false;
}
...
void Assembler::readRegisterOperand(std::string &input, int &regIndex, bool &imm) {
    ...
    if(operString[0] == 'r' && operString[1] == 'a') {
        ...
        imm = true;
        return;
    }else if (operString[0] == 'o' && operString[1] == 'l' && operString[2] == 'd' && operString[3] == 'p' && operString[4] == 'c' ){ //add
        regIndex = 1;
        imm = false;
        return;
    }
    else if (operString[0] == 'o' && operString[1] == 'l' && operString[2] == 'd' && operString[3] == 's' && operString[4] == 'p' ){ //add
        regIndex = 2;
        imm = false;
        return;
    }else if (operString[0] == 'f' && operString[1] == 'l' && operString[2] == 'a' && operString[3] == 'g' && operString[4] == 's'){ //add
        regIndex = 3;
        imm = false;
        return;
    }
    else if (operString[0] == 'o' && operString[1] == 'l' && operString[2] == 'd' && operString[3] == 'f' && operString[4] == 'l'&& operString[5] == 'a' && operString[6] == 'g' && operString[7] == 's'){ //add
        regIndex = 4;
        imm = false;
        return;
    }   
   /* else if (operString.compare("causereg")==0 ){ //add
        regIndex = 5;
        imm = false;
        return;
    }*/
